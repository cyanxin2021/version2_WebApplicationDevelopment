...
import test01.dao.OrderDao;
import test01.dao.OrderItemDao;
import test01.dao.ProductDao;
...
public class OrderService {
	...
	public List<Order> findOrderByManyCondition(String id, String receiverName, String userName, String category) {
		List<Order> orders = null;
		try {
			orders = odao.findOrderByManyCondition(id, receiverName, userName, category);
		} catch (SQLException e) {
			e.printStackTrace();
		}
		return orders;
