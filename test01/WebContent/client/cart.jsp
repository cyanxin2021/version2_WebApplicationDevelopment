									...
									<tr>
										<td>
											...
											<div style="text-align:right; margin-top:10px">
											    <!--继续购物 -->
												<a href="${pageContext.request.contextPath}/showProductByPage" style="background-color:#6495ED" class="btn"> <<继续购物</a>
												&nbsp;&nbsp;&nbsp;&nbsp;
                                                 <!--结账 -->
												<a href="${pageContext.request.contextPath}/client/order.jsp" style="background-color:#F08080" class="btn">结&nbsp;&nbsp;&nbsp;&nbsp;算>></a>
											</div>
										</td>
									</tr>
								</table>
